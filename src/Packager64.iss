...
#define PaleoPackagerAppExeName "..\bin\PaleoPackager64.exe"
...
[Setup]
AppId={{8B56602B-6E85-4705-8BCC-F4590654BA32}
...
OutputDir=..\bin
OutputBaseFilename=PaleoPackager_{#PaleoPackagerAppVersion}_Win64_Setup
Compression=lzma
